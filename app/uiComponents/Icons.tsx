...
export const SettingsIcon: React.FC<{size: number}> = ({ size = 60 }) =>
  <Svg height={size} width={size} viewBox="0 0 24 24" fill="#C7E83C">
...
export const MysteryIcon: React.FC<{size: number}> = ({ size = 60 }) => (
  <Svg height={size} width={size} viewBox="0 0 100 100">
    <Circle cx="50" cy="50" r="45" fill="#2c3e50" stroke="#C7E83C" strokeWidth="2"/>
    <Path d="M50 20 Q60 20 60 30 L60 45 Q60 55 50 55 Q40 55 40 45 L40 30 Q40 20 50 20 Z" fill="#C7E83C" />
    <Circle cx="50" cy="75" r="5" fill="#C7E83C" />
  </Svg>
);

export const FileIcon: React.FC<{size: number}> = ({ size = 60 }) => (
  <Svg height={size} width={size} viewBox="0 0 40 40">
    <Path d="M5 5 L25 5 L35 15 L35 35 L5 35 Z" fill="#667588FF" />
    <Path d="M25 5 L25 15 L35 15" fill="none" stroke="#F1F3FFFF" strokeWidth="2" />
  </Svg>
);